...
### 1️⃣ Surplus Food Management
- Donors can **upload food items** with quantity and freshness timer.  
- **Live interactive map** shows donor location using browser geolocation.  
- Freshness timers **auto-update and remove expired items**.  
- Receivers can **view available food items in real time** and “claim” them.  
- Demonstrates **real-time problem-solving for food waste reduction**.

### 2️⃣ Waste Minimisation
- Camera access opens **reliably in-browser** for waste monitoring.  
- Waste type can be **manually selected** (Plastic / Organic / Metal).  
- **Illegal dumping alerts** with geolocation capture.  
- Highlights **smart urban cleanliness solutions** and automated reporting.

### 3️⃣ Water Sustainability
- Users can **register apartments or business locations**.  
- **Rain prediction** simulation shows smart water harvesting.  
- **Smart tank monitoring** linked to registered locations.  
- Demonstrates **efficient use of rainwater and greywater recycling**.

---

## 💻 Technology Stack
- **HTML, CSS, JavaScript** – Front-end development  
- **Leaflet.js + OpenStreetMap** – Interactive live maps  
- **Browser Geolocation API** – Donor & dumping location tracking  
- **Camera API (getUserMedia)** – Waste monitoring simulation  
- Fully **front-end**, deployable on **GitHub Pages**
